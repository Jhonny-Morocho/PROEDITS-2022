...
use Carbon\Carbon;
trait TemplateCorreoPaymentez {
    //productos cuando compra productos de la tienda
    public static function templateFacturaPaymentezProductos($idFactura,$idTranPaymentez,$codifoAutorizacinPaymentez){
        $tabla="";
        $total=0.0;
        $pedido=Pedido::where('id_transaccion',$idFactura)->first();
        $productos=PedidoProducto::join('productos','productos.id','id_producto')
        ->select('productos.url_directorio','pedido_producto.*')
        ->where('id_pedido',$pedido->id)->get();
        foreach ($productos as $key => $value) {
          $precioUnitario=$value['precio_venta'];
          $total=$value['precio_venta']+$total;
                ...
                <tr>
                        ...
                        <div style="margin-top: 20px;">
                            ...
                            <p
                                ...
                                width: 100%;
                                margin: 0;"
                                align="left"><b>Código de autorización:</b>
                                '.$codifoAutorizacinPaymentez.'
                             </p>
    ...
    public static function templateFacturaPaymentezMembresia($idFactura,$idTranPaymentez,$codifoAutorizacinPaymentez){
        $tabla="";
